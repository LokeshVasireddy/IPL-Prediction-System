...
def load_data():
    ...
    matches = pd.read_parquet(
        "../ml-service/data/processed/v3_gamma/clean_matches.parquet"
    )
    print("Loaded:", balls.shape, matches.shape)
    return balls, matches


def preprocess_balls(balls, matches):
    ...
    print("After grouping:", balls.shape)
    ...
    print("After wide expansion:", balls.shape)
    ...
    print("After legal filtering:", balls.shape)
    ...
    print("Before manual fixes:", balls.shape)
...
def main():
    ...
    balls = preprocess_balls(balls, matches)
    save_data(balls)
